package com.yeseung.sgyjsecurityspringbootstarter.config;


import com.yeseung.sgyjsecurityspringbootstarter.jwt.*;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.httpBasic(AbstractHttpConfigurer::disable)
            ...
            .exceptionHandling(handle -> handle.accessDeniedHandler(jwtAccessDeniedHandler).authenticationEntryPoint(unAuthorizedHandler)).headers(
                ...
                SessionCreationPolicy.STATELESS)).authorizeHttpRequests(request -> request.requestMatchers("/actuator/**").permitAll()
